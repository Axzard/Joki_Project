                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Merchandise', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                        Text('Malut', style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold)),
                        Text('United', style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: products.isEmpty
                      ? Center(child: Text('Belum ada produk.', style: TextStyle(color: Colors.white)))
                      : ListView.builder(
